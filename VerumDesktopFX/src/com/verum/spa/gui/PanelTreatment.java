...
public class PanelTreatment implements Initializable {
    ...
    @FXML
    TableView<Treatment> tblvTreatmentTable;

    @FXML
    TableColumn<Treatment, Integer> tblcTreatmentId;
    @FXML
    TableColumn<Treatment, String> tblcTreatmentName;
    @FXML
    TableColumn<Treatment, String> tblcTreatmentDesc;
    @FXML
    TableColumn<Treatment, String> tblcTreatmentCost;
    @FXML
    TableColumn<Treatment, Byte> tblcTreatmentStatus;
