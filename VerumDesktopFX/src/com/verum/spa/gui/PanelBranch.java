...
public class PanelBranch implements Initializable {
    ...
    @FXML
    private TableColumn<Branch, Double> latitudeColumn;
    @FXML
    private TableColumn<Branch, Double> longitudeColumn;
    @FXML
    private TableColumn<Branch, String> branchStatusColumn;
        ...
        btnSaveBranch.setOnAction((ActionEvent evt) -> {
            ...
            try {
                ...
                if (accept) {
                    ...
                    alert.setContentText("Se ha actualizado el dato");
                    alert.showAndWait();
                } else {
